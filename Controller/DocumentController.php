...
use BisonLab\SakonninBundle\Entity\Document;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $documents = $em->getRepository('BisonLabSakonninBundle:Document')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BisonLab\SakonninBundle\Form\DocumentType', $document);
    ...
    {
        $deleteForm = $this->createDeleteForm($document);
        $editForm = $this->createForm('BisonLab\SakonninBundle\Form\DocumentType', $document);
